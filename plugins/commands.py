...
async def help(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("How to Deploy?", url="https://t.me/pocketmovieschannel"),
                    InlineKeyboardButton("About Me", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("BOT Channel", url="https://t.me/pocketmovieschannel"),
                    InlineKeyboardButton("Support Group", url="https://t.me/Pocketmoviesgroup")
                ]
            ]
        ),
        reply_to_message_id=message.message_id
            ...
            [
                [
                    InlineKeyboardButton(
                        "SOURCE CODE", url="https://github.com/Happy9012/Unlimited-Filter-Bot")
                ],
                [
